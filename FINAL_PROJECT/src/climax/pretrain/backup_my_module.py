...
# MODIFIED module.py TO WORK WITH MODIFIED arch.py
...
class PretrainModule(LightningModule):
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        loss_dict, _ , mode, mse_loss = self.net.forward(x, y, lead_times, variables, out_variables, [lat_weighted_mse], lat=self.lat)
        if mode == "mse":
            return mse_loss
