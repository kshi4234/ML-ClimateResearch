...
class MultiSourceDataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        if not torch.distributed.is_initialized():
            ...
            my_nodes = os.environ.get("NODES", None)
            # print("MY NODES:", my_nodes)
            # print("NODES:", num_nodes)
            # print("DICT LENGTH:", len(self.dict_data_train.keys()))
            # print("DICT KEYS:", self.dict_data_train.keys())
            # print("NODE NAMES:", os.environ["SLURM_JOB_NODELIST"])
